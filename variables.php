...
*/
    $totalTax = $price * $tax;
        $afterTax = $totalTax + $price;

    $totalDelivery =  $afterTax * $delivery;
        $afterDelivery = round($afterTax + $totalDelivery,2);
...
*/
    echo '<figure>
            <img src="https://placehold.jp/24/e8d2ae/fff/300x300.png" alt="placeholder-image">
            <figcaption>' .$afterDelivery. '</figcaption>
         </figure>'
